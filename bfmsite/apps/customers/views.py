...
from apps.customers.models import BFCustomer
from apps.domains.models import Account
  ...
  if 'terms' in request.POST:
            ...
            try:
              if 'autorenew' in request.POST:
                ...
                acctemail = EmailMessage('New Account', message, 'support@bigfanmail.com', [BigFanAcct.customer.email], settings.ADMINS, headers = {})
                acctemail.send()
